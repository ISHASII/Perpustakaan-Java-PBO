...
public class MenuKategori extends javax.swing.JPanel {
    ...
    private static final String Deskripsi_Kategori = "Deskripsi_Kategori";
    ...
    private void initComponents() {
        ...
        jtxt_deskripsi = new property.JtextfieldroundedCustom();
        ...
        jLabel7.setText("Tambah Data Kategori Buku");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-dashboard-30.png"))); // NOI18N

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-category-30.png"))); // NOI18N
        ...
        jtxt_deskripsi.setLineColor(new java.awt.Color(153, 0, 51));
        jtxt_deskripsi.setPlaceholder("Masukkan Deskripsi Buku");
        jtxt_deskripsi.setSelectionColor(new java.awt.Color(153, 0, 51));
        jtxt_deskripsi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtxt_deskripsiActionPerformed(evt);
            }
        });
        ...
        jpn_addLayout.setHorizontalGroup(
            ...
            .addGroup(jpn_addLayout.createSequentialGroup()
                ...
                .addGroup(jpn_addLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jtxt_deskripsi, javax.swing.GroupLayout.PREFERRED_SIZE, 560, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jpn_addLayout.createSequentialGroup()
        ...
        jpn_addLayout.setVerticalGroup(
            ...
            .addGroup(jpn_addLayout.createSequentialGroup()
                ...
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtxt_deskripsi, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(410, 410, 410))
        );
    ...
    private void jtxt_deskripsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtxt_deskripsiActionPerformed

    }//GEN-LAST:event_jtxt_deskripsiActionPerformed
    ...
    private property.JtextfieldroundedCustom jtxt_deskripsi;
    ...
    private void insertData() {
        String idKategori = setIDKategori();
        String namaKategori = jtxt_nama.getText();
        ...
        try{
            ...
            try (PreparedStatement stCheck = conn.prepareStatement(sqlCheck)) {
                ...
                if (rsCheck.next()) {
                    JOptionPane.showMessageDialog(this, "ID Kategori sudah ada dalam database. Silakan coba lagi.", "Valisasi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
    ...
    private void updateData() {
        ...
        try {
            ...
            try (PreparedStatement stCheck = conn.prepareStatement(sqlCheck)) {
                ...
                ResultSet rsCheck = stCheck.executeQuery();
                if (!rsCheck.next()) {
                    JOptionPane.showMessageDialog(this, "ID Kategori tidak ditemukan dalam database. Silakan tambahkan data baru.", "Validasi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
    ...
    private void searchData() {
        ...
        try{
            String sql = "SELECT * FROM kategori WHERE ID_Kategori LIKE ? OR Nama_Kategori LIKE ? OR Deskripsi_Kategori LIKE ?" ;
            try(PreparedStatement st = conn.prepareStatement(sql)){
